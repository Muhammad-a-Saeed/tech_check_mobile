...
const PreCheckList = ({navigation}) => {
  ...
  const handleNext = () => {
    if (currentIndex === 3) return navigation.navigate(ROUTES.PostCheckList);
  ...
  return (
    <Screen>
      ...
      <AppScrollView>
        ...
        <StepBar activeStep={currentIndex} totalSteps={3} />
        <AppText style={checkListDetailsStyles.boldText}>Pre Check List From Technician</AppText>
        {currentIndex === 1 && (
          <View>
            <View>
